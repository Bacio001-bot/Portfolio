...
<div class=" w-full bg-white shadow rounded-lg p-[2rem] px-[5rem] grid gap-y-4">
    <h1 class="text-2xl font-semibold text-gray-300 mb-8 border-b pb-4">Update a company</h1>
    ...
    <form action="{{route('company.update', ['company' => $company])}}" method="POST">
        ...
        <div class=" grid gap-y-4">
            <div>
                ...
                <div class="mt-1">
                    <input type="text" name="name" id="name"
                        ...
                        value="@if($company->name){{$company->name}}@endif">
                </div>
            </div>
            <div>
                ...
                <div class="mt-1">
                    <input type="email" name="email" id="email"
                        ...
                        value="@if($company->email){{$company->email}}@endif">
                </div>
            </div>
            <div>
                ...
                <div class="mt-1">
                    <input type="url" name="logo" id="logo"
                        ...
                        value="@if($company->logo){{$company->logo}}@endif">
                </div>
            </div>
            <div>
            ...
            <button type="submit" class=" py-2 w-[8rem] text-center px-6 border border-transparent font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 gap-x-5">Update</button>
        </div>
